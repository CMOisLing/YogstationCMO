...
/datum/techweb_node/nanite_base
	...
	design_ids = list("nanite_disk","nanite_remote","nanite_comm_remote","nanite_scanner",\
						...
						"relay_nanites","monitoring_nanites","access_nanites","repairing_nanites","sensor_nanite_volume","repeater_nanites","relay_repeater_nanites","nanite_toxic_replication",\
						"nanite_mitocondrial_replication", "nanite_endothermic_replication", "nanite_solar_regeneration") //added here
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1000)
